[![Build Status](https://travis-ci.org/Nameoj/js-training.svg?branch=master)](https://travis-ci.org/nan-academy/js-training)
## Setup
First, [**fork**](https://github.com/Nameoj/js-training/fork?fragment=1) this repository.
### globals dependencies
install globaly node on your computer

```sh
# download your code locally
git clone https://github.com/Nameoj/js-training.git
